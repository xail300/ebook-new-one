        ...
        <div className="row justify-content-center">
          <div className="col-xl-5 col-lg-4 col-md-12">
            <div className="footer-logo text-center">
              <Link href="/"><Image src="/assets/images/logo.png" alt="" width={113} height={49} /></Link>
        ...
        <div className="row pb-2 pt-4">
          ...
          <div className="col-xl-3 col-lg-3 col-md-6 col-6">
            <div className="footer-links mb-0">
              <h6>Reach Us</h6>
              <ul className="list-unstyled">
                <li><Link className="d-flex align-items-center justify-content-lg-start justify-content-center gap-2" href="tel:1234567890"><i className="ri-smartphone-line"></i> 1234567890</Link></li>
                <li><Link className="d-flex align-items-center justify-content-lg-start justify-content-center gap-2" href="tel:1234567890"><i className="ri-whatsapp-line"></i> 1234567890</Link></li>
                <li><Link className="d-flex align-items-center justify-content-lg-start justify-content-center gap-2" href="mailto:info@gmail.com"><i className="ri-mail-line"></i> info@gmail.com</Link></li>
              </ul>
            </div>
          </div>
        </div>
